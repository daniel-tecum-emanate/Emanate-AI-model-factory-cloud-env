# qa-cursor-synth — synthetic cursor-dispatch test node

Node: S4 | run: dddddddd-0000-0000-0000-000000000001 | graph: fine-tune-factory-v1 | org: qa-dryrun-synth

## Read first
- factory-automation/automation-graph/PLAN.md
